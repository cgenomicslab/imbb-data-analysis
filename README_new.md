...
**R (Week 2):** Some Week 2 sessions use R. Install [R](https://cran.r-project.org) and [RStudio Desktop](https://posit.co/download/rstudio-desktop/) — see [docs/SETUP.md](docs/SETUP.md) Step 6 for details. Alternatively, you can add R to your conda environment to run R notebooks in Jupyter/VSCode.
...
- IMBB-FORTH lab members (Undergraduate, MSc students, PhD students, Postdocs, Technicians) with **no programming experience**
...
After sessions, we **welcome feedback on pace, clarity, and content**.
